...
const HeroSection = () => {
  return (
    <section className="relative h-[500px] md:h-[600px] overflow-hidden">
      <img
        src="https://images.deliveryhero.io/image/foodpanda/homepage/refresh-hero-home-tr.png?width=960"
          ...
          <div className="flex flex-col md:flex-row gap-2 max-w-[600px]">
            <div className="relative flex-grow">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 rounded-lg border border-gray-200 focus:outline-none focus:border-[#e80370] focus:ring-1 focus:ring-[#e80370]"
              />
            </div>

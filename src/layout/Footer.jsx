    ...
    <footer className=" py-10">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="border-t border-gray-200 pt-10 mt-15">
          ...
          <div className="grid grid-cols-4 gap-4 text-gray-700 mb-8">
            <Link
              to="/istanbul"
        ...
        <div className="border-t  border-gray-200 pt-10 mt-15">
          ...
          <div className="grid grid-cols-4 gap-4 text-gray-700 font-medium">
            <Link
              to="/adana"
              className="relative text-gray-700 underline decoration-1 transition-all duration-1000 hover:decoration-3 underline-offset-4"
            >
        ...
        <div className="flex justify-end border-t border-gray-200 pt-10 mt-15">
        ...
        <div className="border-t border-gray-200 pt-10 mt-5 text-gray-600 text-sm flex justify-between  font-medium">
          <p className="mt-5">© EkmeklenYe</p>
          <div className="flex justify-between mt-5">
            <div className="grid grid-cols-3 gap-8 gap-x-20">
              <Link
                to="/"
                className="relative text-gray-700 underline decoration-1 transition-all duration-1000 hover:decoration-3 underline-offset-4"
              >
